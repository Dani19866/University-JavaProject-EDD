...
public class App {
    ...
    private LinkedList<Relations> relationsList = new LinkedList();

    // <editor-fold defaultstate="collapsed" desc="GUI's"> 
    public void showIslands() {
        IslandsGUI islands = new IslandsGUI();
    ...
    public void fileReader(boolean aux, JFrame MainFrame) {
        ...
        if (aux) {
            ...
            if (select == JFileChooser.APPROVE_OPTION) {
                ...
                String destinationFile = System.getProperty("user.dir") + File.separator + "src\\App" + File.separator + nameFile;
